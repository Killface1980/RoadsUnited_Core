            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                try
                {
                    ...
                    for (int j = 0; j < prefabs.Length; j++)
                    {
						...
						string text=Path.Combine(ModLoader.currentTexturesPath_default,str+"_MainTex.dds");
						string text2=Path.Combine(ModLoader.currentTexturesPath_default,str+"_ACIMap.dds");
