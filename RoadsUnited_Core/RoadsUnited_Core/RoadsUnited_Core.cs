                            ...
                            if (netInfo.name.Contains("Oneway3L"))
                            {
                                ...
                                if (segment.m_segmentMaterial.GetTexture("_APRMap").name.Contains("Elevated"))
                                    if (File.Exists(Path.Combine(ModLoader.currentTexturesPath_default, "OneWay3L_Elevated_Segment_APRMap.dds")))
                                        segment.m_segmentMaterial.SetTexture("_APRMap", LoadTextureDDS(Path.Combine(ModLoader.currentTexturesPath_default, "OneWay3L_Elevated_Segment_APRMap.dds")));
                                    else if (File.Exists(Path.Combine(ModLoader.APRMaps_Path, "OneWay3L_Elevated_Segment_APRMap.dds")))
                                        segment.m_segmentMaterial.SetTexture("_APRMap", LoadTextureDDS(Path.Combine(ModLoader.APRMaps_Path, "OneWay3L_Elevated_Segment_APRMap.dds")));
                            ...
                            if (netInfo.name.Contains("Oneway4L"))
                            {
                                ...
                                if (segment.m_segmentMaterial.GetTexture("_APRMap").name.Contains("Elevated"))
                                    if (File.Exists(Path.Combine(ModLoader.currentTexturesPath_default, "OneWay4L_Elevated_Segment_APRMap.dds")))
                                        segment.m_segmentMaterial.SetTexture("_APRMap", LoadTextureDDS(Path.Combine(ModLoader.currentTexturesPath_default, "OneWay4L_Elevated_Segment_APRMap.dds")));
                                    else if (File.Exists(Path.Combine(ModLoader.APRMaps_Path, "OneWay4L_Elevated_Segment_APRMap.dds")))
                                        segment.m_segmentMaterial.SetTexture("_APRMap", LoadTextureDDS(Path.Combine(ModLoader.APRMaps_Path, "OneWay4L_Elevated_Segment_APRMap.dds")));
                            ...
                            if (netInfo.name.Contains("Small Avenue"))
                            {
                                ...
                                if (segment.m_segmentMaterial.GetTexture("_APRMap").name.Contains("Elevated"))
                                    if (File.Exists(Path.Combine(ModLoader.currentTexturesPath_default, "SmallAvenue4L_Elevated_Segment_APRMap.dds")))
                                        segment.m_segmentMaterial.SetTexture("_APRMap", LoadTextureDDS(Path.Combine(ModLoader.currentTexturesPath_default, "SmallAvenue4L_Elevated_Segment_APRMap.dds")));
                                    else if (File.Exists(Path.Combine(ModLoader.APRMaps_Path, "SmallAvenue4L_Elevated_Segment_APRMap.dds")))
                                        segment.m_segmentMaterial.SetTexture("_APRMap", LoadTextureDDS(Path.Combine(ModLoader.APRMaps_Path, "SmallAvenue4L_Elevated_Segment_APRMap.dds")));
